...
export const SolutionsPageNew: React.FC = () => {
  return (
    <div className="min-h-screen bg-white text-[#0f172a] font-sans relative">
          ...
          <div className="max-w-[1600px] mx-auto px-6 md:px-12 lg:px-16 relative z-10">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-slate-700 leading-relaxed font-normal">
                A selection of applied AI and data engineering work — from rapid prototypes to production-grade architectures. Each solution was designed to turn ambiguity into clarity at speed.
              </p>
            </motion.div>
          </div>
        </div>
      ...
      {/* ── Solution Cards ── */}
      <main className="max-w-[1600px] mx-auto px-6 md:px-12 lg:px-16 pb-24 space-y-24 relative z-10">
        {solutionsList.map(({ number, category, title, description, detail, stack, Diagram, accent }, idx) => (
          <motion.div
            key={number}
            custom={idx}
            variants={fadeUp}
